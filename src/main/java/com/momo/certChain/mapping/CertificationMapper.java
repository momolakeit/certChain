...
@Mapper(uses ={AddressMapper.class,SimpleStudentMapper.class,SignatureMapper.class,SimpleInstitutionMapper.class,ImageFileMapper.class,SimpleLienMapper.class,SimpleCampagneMapper.class})
